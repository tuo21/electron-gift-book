...
const icons: Record<string, string> = {
  ...
  'import': `<path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="17 10 12 15 7 10"/><line x1="12" y1="15" x2="12" y2="3"/><path d="M12 3v12"/><polyline points="7 8 12 3 17 8"/>`,
  ...
  'keyboard': `<rect x="2" y="4" width="20" height="16" rx="2" ry="2"/><circle cx="6" cy="8" r="1"/><circle cx="10" cy="8" r="1"/><circle cx="14" cy="8" r="1"/><circle cx="18" cy="8" r="1"/><circle cx="6" cy="12" r="1"/><circle cx="10" cy="12" r="1"/><circle cx="14" cy="12" r="1"/><circle cx="18" cy="12" r="1"/><line x1="6" y1="16" x2="18" y2="16"/>`,
  'book-plus': `<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z"/><line x1="12" y1="6" x2="12" y2="14"/><line x1="9" y1="10" x2="15" y2="10"/>`,
  ...
  'palette': `<circle cx="13.5" cy="6.5" r="0.5"/><circle cx="17.5" cy="10.5" r="0.5"/><circle cx="8.5" cy="7.5" r="0.5"/><circle cx="6.5" cy="12.5" r="0.5"/><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.563-2.512 5.563-5.563C22 6.5 17.5 2 12 2z"/>`,
  
  // 主题图标
  'lantern': `<path d="M12 2a6 6 0 0 1 6 6c0 2.22-1.21 4.16-3 5.2V21a1 1 0 0 1-1 1h-4a1 1 0 0 1-1-1v-7.8A6.002 6.002 0 0 1 12 2z"/><line x1="9" y1="21" x2="15" y2="21"/>`,
  'flower': `<path d="M12 7.5a4.5 4.5 0 1 1 4.5 4.5"/><path d="M12 7.5A4.5 4.5 0 1 0 7.5 12"/><path d="M12 16.5a4.5 4.5 0 1 1-4.5-4.5"/><path d="M12 16.5a4.5 4.5 0 1 0 4.5-4.5"/><circle cx="12" cy="12" r="2"/>`,
  ...
  'sort-asc': `<line x1="12" y1="5" x2="12" y2="19"/><polyline points="5 12 12 5 19 12"/>`,
  'sort-desc': `<line x1="12" y1="5" x2="12" y2="19"/><polyline points="19 12 12 19 5 12"/>`,
  ...
  'wechat': `<path d="M9.5 4C5.36 4 2 6.69 2 10c0 1.89 1.08 3.56 2.78 4.66L4 17l2.5-1.5c.89.31 1.87.5 2.91.5.35 0 .69-.02 1.03-.06-.19-.56-.3-1.16-.3-1.78 0-3.58 3.36-6.5 7.5-6.5.46 0 .91.04 1.34.11C18.1 5.93 14.17 4 9.5 4zM6 9a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm5 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm5.5 4c-3.31 0-6 2.24-6 5s2.69 5 6 5c.6 0 1.18-.08 1.73-.22L20 23l-.67-2.01C20.37 20.14 21 19.13 21 18c0-2.76-2.69-5-6-5zm-2 4a1 1 0 1 1 0-2 1 1 0 0 1 0 2zm4 0a1 1 0 1 1 0-2 1 1 0 0 1 0 2z"/>`,
  ...
  'mail-open': `<path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/>`,
  ...
  'rotate-ccw': `<polyline points="1 4 1 10 7 10"/><path d="M3.51 15a9 9 0 1 0 2.12-9.36L1 10"/>`,
  ...
  'exit-fullscreen': `<path d="M4 8V4m0 0h4M4 4l5 5m11-1V4m0 0h-4m4 0l-5 5M4 16v4m0 0h4m-4 0l5-5m11 5l-5-5m5 5v-4m0 4h-4"/>`,
}
